 ...
 */
public class FrDoubleMetaphone implements StringEncoder {
	 ...
	 * @return an encoded string
	 */
	public String doubleMetaphone(final String _value, final boolean alternate) {
		String value = _value;
	 ...
	 * Handles 'C' cases.
	 */
	private int handleC(final String value, final DoubleMetaphoneResult result, final int _index) {
		int index = _index;
	 ...
	 * Handles 'CC' cases.
	 */
	private int handleCC(final String value, final DoubleMetaphoneResult result, final int _index) {
		int index = _index;
	 ...
	 * Handles 'D' cases.
	 */
	private int handleD(final String value, final DoubleMetaphoneResult result, final int _index) {
		int index = _index;
	 ...
	 * Handles 'G' cases.
	 */
	private int handleG(final String value, final DoubleMetaphoneResult result, final int _index, final boolean slavoGermanic) {
		int index = _index;
	 ...
	 * Handles 'GH' cases.
	 */
	private int handleGH(final String value, final DoubleMetaphoneResult result, final int _index) {
		int index = _index;
	 ...
	 * Handles 'H' cases.
	 */
	private int handleH(final String value, final DoubleMetaphoneResult result, final int _index) {
	 ...
	 * Handles 'J' cases.
	 */
	private int handleJ(final String value, final DoubleMetaphoneResult result, final int _index, final boolean slavoGermanic) {
		int index = _index;
	 ...
	 * Handles 'L' cases.
	 */
	private int handleL(final String value, final DoubleMetaphoneResult result, final int _index) {
		int index = _index;
	 ...
	 * Handles 'P' cases.
	 */
	private int handleP(final String value, final DoubleMetaphoneResult result, final int _index) {
		int index = _index;
		if (charAt(value, index + 1) == 'H') {
			result.append('F');
			index += 2;
	 ...
	 * Handles 'S' cases.
	 */
	private int handleS(final String value, final DoubleMetaphoneResult result, final int _index, final boolean slavoGermanic) {
		int index = _index;
	 ...
	 * Handles 'T' cases.
	 */
	private int handleT(final String value, final DoubleMetaphoneResult result, final int _index) {
		int index = _index;
	 ...
	 * Handles 'W' cases.
	 */
	private int handleW(final String value, final DoubleMetaphoneResult result, final int _index) {
		int index = _index;
	 ...
	 * Handles 'X' cases.
	 */
	private int handleX(final String value, final DoubleMetaphoneResult result, final int _index) {
		int index = _index;
		if (index == 0) {
			result.append('S');
			index++;
	 ...
	 * Handles 'Z' cases.
	 */
	private int handleZ(final String value, final DoubleMetaphoneResult result, final int _index, final boolean slavoGermanic) {
		int index = _index;
		if (charAt(value, index + 1) == 'H') {
	...
	private boolean conditionL0(final String value, final int index) {
		if (index == value.length() - 3 && contains(value, index - 1, 4, "ILLO", "ILLA", "ALLE")) {
			return true;
		} else if ((contains(value, value.length() - 2, 2, "AS", "OS") || contains(value, value.length() - 1, 1, "A", "O")) && contains(value, index - 1, 4, "ALLE")) {
			return true;
		} else {
			return false;
		}
	 ...
	 * Cleans the input.
	 */
	private String cleanInput(final String _input) {
		String input = _input;
		if (input == null) {
			return null;
		}
	...
	public class DoubleMetaphoneResult {
		...
		public void append(final char _primary, final char _alternate) {
			appendPrimary(_primary);
			appendAlternate(_alternate);
		}
		...
		public void append(final String _primary, final String _alternate) {
			appendPrimary(_primary);
			appendAlternate(_alternate);
		}
