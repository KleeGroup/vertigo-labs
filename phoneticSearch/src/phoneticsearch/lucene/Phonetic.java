...
public class Phonetic {
	...
	public static String genererPhonetic(final String str) {

		String[][] conversion = { { "é", "É" }, { "è", "È" }, { "ë", "Ë" }, { "ê", "Ê" }, { "á", "Á" }, { "â", "Â" }, { "à", "À" }, { "Ä", "A" }, { "Â", "A" }, { "å", "Å" }, { "ã", "Ã" }, { "æ", "Æ" }, { "ï", "Ï" }, { "î", "Î" }, { "ì", "Ì" }, { "í", "Í" }, { "ô", "Ô" }, { "ö", "Ö" }, { "ò", "Ò" }, { "ó", "Ó" }, { "õ", "Õ" }, { "ø", "Ø" }, { "œ", "Œ" }, { "ú", "Ú" }, { "ù", "Ù" }, { "û", "Û" }, { "ü", "Ü" }, { "ç", "Ç" }, { "ñ", "Ñ" }, { "ß", "S" } };
		String soundex = str;
		for (int i = 0; i < conversion.length; i++) {
			soundex = soundex.replaceAll(conversion[i][0], conversion[i][1]);
		}

		conversion = new String[][] { { "É", "E" }, { "È", "E" }, { "Ë", "E" }, { "Ê", "E" }, { "Á", "A" }, { "À", "A" }, { "Ä", "A" }, { "Â", "A" }, { "Å", "A" }, { "Ã", "A" }, { "Æ", "E" }, { "Ï", "I" }, { "Î", "I" }, { "Ì", "I" }, { "Í", "I" }, { "Ô", "O" }, { "Ö", "O" }, { "Ò", "O" }, { "Ó", "O" }, { "Õ", "O" }, { "Ø", "O" }, { "Œ", "OEU" }, { "Ú", "U" }, { "Ù", "U" }, { "Û", "U" }, { "Ü", "U" }, { "Ñ", "N" }, { "Ç", "S" }, { "¿", "E" } };
		...
		final String soundexBack = soundex;// on sauve le code (utilisé pour les mots très courts)
		...
		conversion = new String[][] { { "DILAI", "DIAI" }, { "DILON", "DION" }, { "DILER", "DIER" }, { "DILEM", "DIEM" }, { "RILON", "RION" }, { "TAILE", "TAIE" }, { "GAILET", "GAIET" }, { "AILAI", "AIAI" }, { "AILAR", "AIAR" }, { "OUILA", "OUIA" }, { "EILAI", "AIAI" }, { "EILAR", "AIAR" }, { "EILER", "AIER" }, { "EILEM", "AIEM" }, { "REILET", "RAIET" }, { "EILET", "EIET" }, { "AILOL", "AIOL" } };
		...
		// MP MB -> NP NB
		conversion = new String[][] { { "OMB", "ONB" }, { "AMB", "ANB" }, { "OMP", "ONP" }, { "AMP", "ANP" }, { "IMB", "INB" }, { "EMP", "ANP" }, { "GEMB", "JANB" }, { "EMB", "ANB" }, { "UMBL", "INBL" }, { "CIEN", "SIAN" } };
		for (int i = 0; i < conversion.length; i++) {
			soundex = soundex.replaceAll(conversion[i][0], conversion[i][1]);
		}
		...
		conversion = new String[][] { { "EUCHA", "EKA" }, { "YCHIA", "IKIA" }, { "YCHA", "IKA" }, { "YCHO", "IKO" }, { "YCHED", "IKED" }, { "ACHEO", "AKEO" }, { "RCHEO", "RKEO" }, { "RCHES", "RKES" }, { "ECHN", "EKN" }, { "OCHTO", "OKTO" }, { "CHORA", "KORA" }, { "CHONDR", "KONDR" }, { "CHORE", "KORE" }, { "MACHM", "MAKM" }, { "BRONCHO", "BRONKO" }, { "LICHOS", "LIKOS" }, { "LICHOC", "LIKOC" } };
		for (int i = 0; i < conversion.length; i++) {
			soundex = soundex.replaceAll(conversion[i][0], conversion[i][1]);
		}
		...
		conversion = new String[][] { { "GNES", "NIES" }, { "GNET", "NIET" }, { "GNER", "NIER" }, { "GNE", "NE" }, { "GI", "JI" }, { "GNI", "NI" }, { "GNA", "NIA" }, { "GNOU", "NIOU" }, { "GNUR", "NIUR" }, { "GY", "JI" }, { "OUGAIN", "OUGIN" }, { "AGEOL", "AJOL" }, { "AGEOT", "AJOT" }, { "GEOLO", "JEOLO" }, { "GEOM", "JEOM" }, { "GEOP", "JEOP" }, { "GEOG", "JEOG" }, { "GEOS", "JEOS" }, { "GEORG", "JORJ" }, { "GEOR", "JEOR" }, { "NGEOT", "NJOT" }, { "UGEOT", "UJOT" }, { "GEOT", "JEOT" }, { "GEOD", "JEOD" }, { "GEOC", "JEOC" }, { "GEO", "JO" }, { "GEA", "JA" }, { "GE", "JE" }, { "QU", "K" }, { "Q", "K" }, { "CY", "SI" }, { "CI", "SI" }, { "CN", "KN" }, { "ICM", "IKM" }, { "CEAT", "SAT" }, { "CE", "SE" }, { "CR", "KR" }, { "CO", "KO" }, { "CUEI", "KEI" }, { "CU", "KU" }, { "VENCA", "VANSA" }, { "CA", "KA" }, { "CS", "KS" }, { "CLEN", "KLAN" }, { "CL", "KL" }, { "CZ", "KZ" }, { "CTIQ", "KTIK" }, { "CTIF", "KTIF" }, { "CTIC", "KTIS" }, { "CTIS", "KTIS" }, { "CTIL", "KTIL" },
				{ "CTIO", "KSIO" }, { "CTI", "KTI" }, { "CTU", "KTU" }, { "CTE", "KTE" }, { "CTO", "KTO" }, { "CTR", "KTR" }, { "CT", "KT" }, { "PH", "F" }, { "TH", "T" }, { "OW", "OU" }, { "LH", "L" }, { "RDL", "RL" }, { "CHLO", "KLO" }, { "CHR", "KR" }, { "PTIA", "PSIA" } };
		...
		conversion = new String[][] { { "BUTIE", "BUSIE" }, { "BUTIA", "BUSIA" }, { "BATIA", "BASIA" }, { "ANTIEL", "ANSIEL" }, { "RETION", "RESION" }, { "ENTIEL", "ENSIEL" }, { "ENTIAL", "ENSIAL" }, { "ENTIO", "ENSIO" }, { "ENTIAI", "ENSIAI" }, { "UJETION", "UJESION" }, { "ATIEM", "ASIAM" }, { "PETIEN", "PESIEN" }, { "CETIE", "CESIE" }, { "OFETIE", "OFESIE" }, { "IPESI", "BUTIA" }, { "LBUTION", "LBUSION" }, { "BLUTION", "BLUSION" }, { "LETION", "LESION" }, { "LATION", "LASION" }, { "SATIET", "SASIET" } };
		for (int i = 0; i < conversion.length; i++) {
			soundex = soundex.replaceAll(conversion[i][0], conversion[i][1]);
		}
		...
		// NASALES
		conversion = new String[][] { { "OMT", "ONT" }, { "IMB", "INB" }, { "IMP", "INP" }, { "UMD", "OND" }, { "TIENT", "TIANT" }, { "RIENT", "RIANT" }, { "DIENT", "DIANT" }, { "IEN", "IN" }, { "YMU", "IMU" }, { "YMO", "IMO" }, { "YMA", "IMA" }, { "YME", "IME" }, { "YMI", "IMI" }, { "YMN", "IMN" }, { "YM", "IN" }, { "AHO", "AO" }, { "FAIM", "FIN" }, { "DAIM", "DIN" }, { "SAIM", "SIN" }, { "EIN", "AIN" }, { "AINS", "INS" } };
		for (int i = 0; i < conversion.length; i++) {
			soundex = soundex.replaceAll(conversion[i][0], conversion[i][1]);
		}
		...
		final String soundexBack2 = soundex; // on sauve le code (utilisé pour les mots très courts)
