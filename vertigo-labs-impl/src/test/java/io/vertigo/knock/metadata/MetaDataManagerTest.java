...
import io.vertigo.knock.plugins.metadata.tika.AutoTikaMetaData;
import io.vertigo.knock.plugins.metadata.txt.TxtMetaData;
...
public final class MetaDataManagerTest extends AbstractTestCaseJU4 {
	...
	private MetaDataContainer buildMDC(final String fileName) {
		try {
			...
			final KFile file = fileManager.createFile(new File(fileURI));
