...
public final class MetaDataManagerImpl implements MetaDataManager {
	...
	private static MetaDataContainer extractMetaData(final MetaDataExtractorPlugin metaDataExtractor, final KFile file) {
		try {
	...
	private static void extractMetaData(final MetaDataContainerBuilder metaDataContainerBuilder, final KFile kFile) {
