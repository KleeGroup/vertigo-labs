 ...
 * Objet de donn�es AbstractDocumentResult
 */
@DtDefinition(persistent = false)
public final class DocumentResult implements DtObject {
	/** SerialVersionUID. */
	 ...
	 */
	@Field(domain = "DO_DOC_URL", type = "PRIMARY_KEY", required = true, persistent = false, label = "URL du document")
	...
	/**
	 * Champ : DATA.
	 * R�cup�re la valeur de la propri�t� 'R�sum�'. 
	 * @return String summary 
	 */
	@Field(domain = "DO_DOC_CONTENT", persistent = false, label = "R�sum�")
	...
	/**
	 * Champ : DATA.
	 * D�finit la valeur de la propri�t� 'R�sum�'.
